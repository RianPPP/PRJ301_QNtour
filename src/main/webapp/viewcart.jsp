        ...
        <footer>
            <div class="container">
                ...
                <div class="footer-right">
                    <h4>Contact To Us</h4>
                    <p>Address: R639+HM2, Khu do thi moi, Quy Nhon, Binh Đinh 55117</p>
                    <p>Phone: (+84) 035 664 5624</p>
                    <p>Email: InfinityShop@gmail.com</p>
                </div>
            </div>
            <div class="footer-bottom">
                Copyright © 2024. Designed by Group4
            </div>
        </footer>
