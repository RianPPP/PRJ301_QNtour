...
public class MyOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("addOrder".equals(action)) {
                ...
                SendMail.send(email, "Confirm purchase at InfinityShop website!", message(fullname, phone, address, email, payment1, payment2, note, total, product_id, img, title, quantity, price, sale_price, orderID, user_id));
    ...
    private String message(String fullname, String phone, String address, String email, String payment1, String payment2, String notes, float total, String[] product_id,
        ...
        return "<!DOCTYPE html>\n"
                ...
                + "                                    <span class=\"phone\">" + phone + "</span><br><span class=\"address\">Quy Nhon</span>\n"
                + "                                </div>\n"
