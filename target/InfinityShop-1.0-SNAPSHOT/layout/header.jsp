    ...
    <div class="header-top" style="background-color: #242424;" >
        <div class="container">
            <div class="top-bar left">
                <ul>
                    <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>  InfinityShop@gmail.com</a></li>
    ...
    <div class="header-bottom">
        <div class="container">
            <div class="main-content">
                <div class="logo">
                    <img onclick="window.location = 'Home'" src="https://cdn.pixabay.com/photo/2022/08/24/23/12/apple-7408883_1280.png" 
                     alt="biolife logo" 
